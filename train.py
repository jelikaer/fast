...
def main(_):
  ...
  WANTED_WORDS = "_background_noise_,vehicles"
  ...
  DATASET_DIR =  '/Users/elizabeth/tools/urban noise/dataset/'
  LOGS_DIR = '/Users/elizabeth/tools/urban noise/logs/'
  TRAIN_DIR = '/Users/elizabeth/tools/urban noise/train/' # for training checkpoints and other files.
  ...
  for training_step in xrange(start_step, training_steps_max + 1):
    ...
    print ("data or train_fingerprints: ")

    print (train_fingerprints.ndim)
    print (train_fingerprints.shape)
    print (train_fingerprints.size)
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--data_dir',
      type=str,
      default='/home/prolab/urban/dataset/',
      help="""\
  ...
  parser.add_argument(
      '--eval_step_interval',
      type=int,
      default=400, #was originally 400
  ...
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/home/prolab/urban/logs',
      help='Where to save summary logs for TensorBoard.')
  parser.add_argument(
      '--wanted_words',
      type=str,
      default='vehicles,york_rail,york_traffic',
      help='Words to use (others will be added to an unknown label)',)
  parser.add_argument(
      '--train_dir',
      type=str,
      default='/home/prolab/urban/train',
